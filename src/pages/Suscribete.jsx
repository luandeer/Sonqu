...
const Suscribete = () => {
    ...
    const cajas = [
        {
            descripcion:
                "Suscríbete solo en dos pasos: Realiza el pago y registra tus datos en el formulario.",
        },
        {
            ...
            <div className="container-suscribete-1">
                ...
                <div className="container-suscribete-1-2">
                    <h1 className="title-2">
                        ¡Felicidades ya casi eres miembro de nuestra comunidad!
                    </h1>

                    <p className="container-suscribete-1-parrafo">
                        Solo faltaría realizar el pago(envíanos la captura) y registrar tus
                        datos en nuestro formulario mediante el botón rojo y asi obtendrás
                        todos los beneficios que ofrece Sonqu.
                    </p>
                    <a className="container-suscribete-1-boton" href="#pagos">
                        <RxEyeOpen />
                        Ver los medios de pago
                    </a>
                    <a
                        className="container-suscribete-3-boton"
                        href="https://api.whatsapp.com/send?phone=51938091040&text=Hola,%20sonqu.%20Voy%20a%20enviarte%20la%20captura%20del%20pago%20que%20acabo%20de%20hacer."
                        target="_blank"
                    >
                        <BsWhatsapp />
                    ...
                    <a
                        className="container-suscribete-1-boton"
                        href="https://forms.gle/5Ea4yKFKCXYdnxGp8"
                        target="_blank"
                    >
                        <MdOutlineOpenInNew />
                        Regístra tus datos Aquí
                    </a>
                </div>
            </div>
